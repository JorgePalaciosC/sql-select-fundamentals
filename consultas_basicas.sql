...
-- Tiene sentido usar está sentencía cunado se necesita explorar por completo la tabla
-- No tiene sentido usarla si ya se conoce la estructura y su contenido por que consume mucho tiempo si la tabla contiene muchos regsitros
SELECT * FROM sales;

-- Consulta 2: Selección de columnas específicas para finanzas
SELECT customer_id, product_id, total_amount FROM sales; 

-- Consulta 3: Selección con alias en español para stakeholder
